...
const {Value, event,
    ...
    debug,timing,
    clockRunning,interpolate,
    Extrapolate,concat} = Animated;
       ...
       <Animated.View
        ...
        >
          <Svg height={height} width={width}>
            <ClipPath id="clip">
              <Circle r={height+100} cx={ width / 3 }/>
            </ClipPath>
            <Image
            href={require('./download1.jpg')}
            width={width}
            height={height +50} 
        ...
        <Animated.View stytle={{ zIndex: this.textInputZindex, 
        ...
        <TextInput style={styles.textInput} placeholder="Enter Your Email" 
          ...
          <TextInput style={styles.textInput} placeholder="Enter Your Password"
           placeholderTextColor='black'
            />
          <Animated.View style={styles.button} onPress={alert("Hello")}>
              <Text style={{fontSize:20,fontWeight:'bold'}} >Sign In</Text>
          </Animated.View>
        </Animated.View>
        </View>
